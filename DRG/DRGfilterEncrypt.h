#ifndef __DRG_FILTER_ENCRYPT_H__
#define __DRG_FILTER_ENCRYPT_H__
...
// Description:
//
// Copied from STMCRYPTO2/DRGfilterEncrypt.
//
...
class DRGfilterEncrypt : public COLfilter
{
public:
   DRGfilterEncrypt( COLsink* pNext_ );
   virtual ~DRGfilterEncrypt();
...
private:
   DRGfilterEncryptPrivate* pMember;
   
   DRGfilterEncrypt( DRGfilterEncrypt& Orig ); // not allowed
   DRGfilterEncrypt& operator=( DRGfilterEncrypt& Orig ); // not allowed
};
