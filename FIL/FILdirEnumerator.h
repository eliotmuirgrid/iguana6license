...
// POSIX and WIN32.
//
// For WIN32 "*.*" will give all the files in a directory.
...
extern const char* FIL_ANYFILE;  // *.* for WIN32 and * for POSIX.

class COL_DLL FILdirEnumerator{
public:
   // A good DirName is "*.*" if you are starting out with this library under WIN32
