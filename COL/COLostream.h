...
// Description:
//
// COLostream translates C and user defined types into text.
//
...
private:
   ...
   friend COL_DLL COLostream& hex(COLostream& _outs);
   friend COL_DLL COLostream& decimal(COLostream& _outs);
...
//
// It is a common technique in our code to re-direct
// these objects to point to different sink objects - i.e.
// we may choose to redirect to a file using FILbinaryFile
// or to the Windows debug log using something like
//
// COLcout.setSink(new COLsinkWindowsDebug(), true);

extern COL_DLL COLostream COLcerr;
extern COL_DLL COLostream COLcout;
extern COL_DLL COLostream COLclog;
...
COL_DLL COLostream& hex(COLostream& _outs);
COL_DLL COLostream& decimal(COLostream& _outs);
...
class COL_DLL COLostreamString : public COLostream
{
public:
   COLostreamString();
