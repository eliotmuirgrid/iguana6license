...
public:
   ...
   typedef COLplaceIteratorAssociative< COLhashmap<KeyType,Type,CompareType> >      TIterator;
   typedef COLplaceIteratorAssociativeConst< COLhashmap<KeyType,Type,CompareType> > TIteratorConst;
