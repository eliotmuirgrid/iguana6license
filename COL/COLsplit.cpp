...
void COLsplit(COLvector<COLstring>* pOutPartList, const COLstring& String, const COLstring& Separator){
   ...
   COLvector<COLstring>& OutPartList = *pOutPartList;
...
void COLjoin(COLstring* pJoined, const COLvector<COLstring>& PartList, const COLstring& Separator, bool Quote) {
...
COLindex COLsplitWhiteSpace(COLvector<COLstring>* pOutPartList, const COLstring& Source, bool KeepSpace) {
