...
#if defined(CHM_WIN) || defined(WIN32)
#   include <windows.h>
#   include <process.h>
#else
#   ifndef CHM_HPUX
...
const COLstring& COLdateTime::dayOfWeekString(COLuint16 DayOfWeekNumber,
                                              bool IsLong)
{   
   DayOfWeekNumber--;
...
const COLstring& COLdateTime::monthNumberToString(COLuint16 MonthNumber,
                                          bool IsLong)
{
   MonthNumber--;
...
{
   return (date.pMember->dt == pMember->dt);
}
...
bool COLdateTime::offsetIsDefined() const
{
   return pMember->OffsetIsDefined;
}

COLdateTime::operator DATE() const
{
   return pMember->dt;
}
...
const COLdateTimeSpan& COLdateTimeSpan::operator+=(const COLdateTimeSpan dateSpan)
{
   return *this = *this + dateSpan; 
}
...
//   if (days() != 0)
//   {
//      Stream << days() << COL_T(" days ");
//   }
//   if (hours() != 0)
//   {
//      Stream << hours() << COL_T(" hours ");
//   }
//   if (minutes() != 0)
//   {
//      Stream << minutes() << COL_T(" minutes ");
//   }
//   if (seconds() != 0)
//   {
...
double COLdateTimeSpan::totalHours() const
{
   return totalDays() * 24;
}

double COLdateTimeSpan::totalMinutes() const
{
   return totalHours() * 60;
}

double COLdateTimeSpan::totalSeconds() const
{
