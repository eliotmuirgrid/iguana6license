...
#ifdef COL_ENABLE_CONDITIONAL_LOGGING // Note: logging is off by default

class COL_DLL COLlogStream : public COLostream
{
   COLstring m_String;
public:
...
class COL_DLL COLfunctionLogger
{
public:
...
#else // !COL_ENABLE_CONDITIONAL_LOGGING
