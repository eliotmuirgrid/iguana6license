...
// operating system independent manner.  This is a replacement
// for FILdll and the PLG library.
//
...
//    unix equivalent)
// 3) Dynamically loading at runtime - this is the idea of a 'plugin'.
//
...
public:
   ...
   COLdllLoadResult tryLoadLibrary(const COLstring& DllFileName, bool IsOwner=true);
